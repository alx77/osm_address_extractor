...
-- Only runs when OSM has no boundary=postal_code data (postcode table empty).
-- Scalar subquery (SELECT COUNT(*) FROM postcode) = 0 evaluates once:
-- if false (DE, PL have OSM polygons) → WHERE filters all rows → INSERT 0 0, instant.
